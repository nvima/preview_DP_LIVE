<template>
    <button class="group m-auto ml-3 sm:ml-6 relative cursor-pointer flex focus:pointer-events-none z-20">
        ...
        <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth='1.5' stroke='currentColor'
            class='w-6 h-6 m-auto ml-1 text-gray-800 group-focus-within:rotate-180'>
            <path strokeLinecap='round' strokeLinejoin='round' d='M19.5 8.25l-7.5 7.5-7.5-7.5' />
        </svg>
        <div class="group-focus-within:block hidden pointer-events-auto">
            <div
                class='grid grid-cols-2 smobile:gap-4 gap-2 w-max h-max absolute rounded-lg border shadow-lg top-14 right-0 p-4 cursor-pointer bg-white smobile:text-base text-sm '>
